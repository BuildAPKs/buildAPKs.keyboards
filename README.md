...
```
To see all possible APK projects run the command: [`cat ma.bash`](https://raw.githubusercontent.com/BuildAPKs/buildAPKs.keyboards/main/ma.bash) in the root directory of this project.  Enjoy!
<!--README.md EOF-->
